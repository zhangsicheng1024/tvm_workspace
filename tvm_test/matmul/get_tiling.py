...
path_rerun = os.path.join(workdir, 'matmul_rerun.py')
path_json = os.path.join(workdir, 'tiling_tmp.json')
path_cu = os.path.join(workdir, 'tiling_tmp.cu')
path_gridblk = os.path.join(workdir, 'tiling_tmp_gridblk.txt')
