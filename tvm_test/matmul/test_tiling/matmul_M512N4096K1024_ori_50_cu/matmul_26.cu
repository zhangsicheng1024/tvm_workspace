      ...
      for (int k_inner = 0; k_inner < 2; ++k_inner) {
        for (int i_c_inner = 0; i_c_inner < 64; ++i_c_inner) {
          for (int j_c_inner = 0; j_c_inner < 2; ++j_c_inner) {
            T_matmul_NN_local[(((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner)] = (T_matmul_NN_local[(((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner)] + (data_shared[((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner)] * kernel_shared[((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 4096)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 4096)] + (data_shared[((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner)] * kernel_shared[(((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner) + 2048)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 8192)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 8192)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 256)] * kernel_shared[((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 12288)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 12288)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 256)] * kernel_shared[(((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner) + 2048)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 16384)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 16384)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 512)] * kernel_shared[((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 20480)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 20480)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 512)] * kernel_shared[(((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner) + 2048)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 24576)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 24576)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 768)] * kernel_shared[((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner)]));
            T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 28672)] = (T_matmul_NN_local[((((i_c_inner * 64) + (j_c_outer_inner * 2)) + j_c_inner) + 28672)] + (data_shared[(((((((int)threadIdx.x) >> 5) * 128) + (i_c_inner * 2)) + k_inner) + 768)] * kernel_shared[(((((k_inner * 4096) + ((((int)threadIdx.x) & 31) * 64)) + (j_c_outer_inner * 2)) + j_c_inner) + 2048)]));
          }
        }
      }
    }
